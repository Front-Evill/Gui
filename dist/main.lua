...
function Section:AddButton(config)
	...
	local rowSize = UDim2.new(1, 0, 0, 0)
	local layoutOrder = #self.Container:GetChildren()
	local isSecondInPair = false

	if self._lastButtonRow and self._lastButtonInstance and self._lastButtonRow.Parent then
		self._lastButtonInstance.Size = UDim2.new(0.5, -4, 0, 0)
		parent = self._lastButtonRow
		rowSize = UDim2.new(0.5, -4, 0, 0)
		layoutOrder = 2
		isSecondInPair = true
		self._lastButtonRow = nil
		self._lastButtonInstance = nil
	else
	...
	if not isSecondInPair then
		self._lastButtonRow = parent
		self._lastButtonInstance = row
	end
...
function M:Window(config)
	...
	local searchIcon, searchBox, searchRow
...
function M:SaveConfig(fileName)
	fileName = fileName or "DevlyxConfig"
