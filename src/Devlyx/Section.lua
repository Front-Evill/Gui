...
function Section:AddBoxInfo(config)
	...
	local showCountPlayers = config.ShowCountPlayers ~= false
	local showServerId = config.ShowServerId ~= false
	local showNameGame = config.ShowNameGame ~= false
	...
	if showCountPlayers then
		countPlayersLabel = addInfoLine(columnRight, 1, "CountPlayers")
		countPlayersLabel.Text = "CountPlayers: " .. currentCountPlayersText()
	end
	...
	if showNameGame then
		nameGameLabel = addInfoLine(columnRight, 3, "NameGame")
		nameGameLabel.Text = "NameGame: " .. currentNameGameText()
	end
